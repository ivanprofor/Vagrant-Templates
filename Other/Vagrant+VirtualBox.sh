...
# Host: Ubuntu 20.04/16.04

# Installation

# Run the script as root!

curl -LO https://releases.hashicorp.com/vagrant/2.2.9/vagrant_2.2.9_x86_64.deb && apt -y install --fix-broken ./vagrant_2.2.9_x86_64.deb


# Vagrant automatically mounts a shared folder between the VM and the host machine. The path to the  mounted folder inside the VM is "/vagrant", and on the host is the folder where the Vagrantfile is, e.g the folder where the VM was vagranted up. In case the VM is destroyed the folder is not deleted.


# Default password for root or other preexisted users inside boxes is "vagrant"


# Vagrant autocomplete module
# https://github.com/brbsix/vagrant-bash-completion
cd /tmp &&\
curl -LO https://raw.github.com/brbsix/vagrant-bash-completion/master/vagrant-bash-completion/etc/bash_completion.d/vagrant &&\
install -m 0644 vagrant /etc/bash_completion.d/

# One's has to enable # virtualbox-5.1 driver in the fo llowing files

# /usr/share/vagrant/plugins/providers/virtualbox/driver/meta.rb
# /usr/share/vagrant/plugins/providers/virtualbox/plugin.rb

# And create another one # /usr/share/vagrant/plugins/providers/virtualbox/driver/version_5_1.rb
...
1. nano /usr/share/vagrant/plugins/providers/virtualbox/driver/meta.rb

# add add "5.1" => Version_5_1, under the line about 5_0

2. nano /usr/share/vagrant/plugins/providers/virtualbox/plugin.rb

# add autoload :Version_5_1, File.expand_path("../driver/version_5_1", __FILE__) under the line about 5_0

3. nano /usr/share/vagrant/plugins/providers/virtualbox/driver/version_5_1.rb

# populate it with the following content:
# from here https://raw.githubusercontent.com/mitchellh/vagrant/b57b0e0d48fe8b4196ca6b7e01bb6c1ecb4b69f9/plugins/providers/virtualbox/driver/version_5_1.rb
